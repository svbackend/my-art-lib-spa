export default {
  seo: {
    name: 'Мій КіноТоп',
    title: 'Каталог фільмів з рекомендаціями від глядачів',
    description: 'Каталог фільмів українською',
    keywords: 'База даних, фільми, кіно, українською, інформація, відгуки, обговорення',
    lang: 'uk',
    movie: {
      title: '{t} {y} дивитись українською онлайн',
      description: '{t} {y} / {ot} {y} переглянути онлайн українською або {t} {y} завантажити в хорошій якості торент, рецензії, актори, рекомендації, подібні фільми',
      keywords: 'Перегляд, завантаження, рецензії, {t} ({y}), {ot} ({y}), рекомендації, подібні фільми, актори',
    },
    actor: {
      title: '{n} біографія українською, фільмографія',
      description: '{n} біографія українською, фільмографія, фотографії, кращі ролі, кращі фільми',
      keywords: 'Біографія, фільмографія, українською',
    },
  },
  app: {
    name: 'MyKino.TOP',
